    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Нове'), ('processing', 'В обробці'), ('completed', 'Завершено'), ('canceled', 'Скасовано')], default='new', max_length=20, verbose_name='Статус замовлення')),
                ('total_price', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, verbose_name='Загальна сума')),
                ('delivery_type', models.CharField(choices=[('pickup', 'Самовивіз'), ('courier', "Доставка кур'єром")], default='pickup', max_length=10, verbose_name='Спосіб доставки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Нове'), ('processing', 'В обробці'), ('completed', 'Завершено'), ('canceled', 'Скасовано')], default='new', max_length=20, verbose_name='Статус товару')),
