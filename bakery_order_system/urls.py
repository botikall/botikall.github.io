...
from orders.views import user_profile, edit_profile,admin_form,update_order_status,admin_order_list,get_notifications,mark_notification_read
from orders.views import add_comment, view_comment, cancel_order,check_join_status,product_catalog,product_detail,add_comment_for_product
...
urlpatterns = [
    ...
    path('add_comment_for_product/', add_comment_for_product, name='add_comment_for_product'),
